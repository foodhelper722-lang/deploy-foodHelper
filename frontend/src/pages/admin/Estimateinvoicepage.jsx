...
//           .estimate-body { padding: 14px 18px !important; }
...
//           {/* ── Body ── */}
//           <div className="estimate-body" style={{ padding: "20px 28px" }}>
...
//                 <div style={val}>
//                   {calcItems.reduce((s, it) => s + it.quantity, 0)}
//                 </div>
//               </div>
//             </div>
